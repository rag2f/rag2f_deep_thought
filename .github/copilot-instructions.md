...
- **Must** consult the official RAG2F documentation *before* proposing or applying code changes when the user request touches core managers/APIs (e.g. `indiana_jones`, `johnny5`, `xfiles`, `morpheus`, `spock`, retrieval/search hooks).
